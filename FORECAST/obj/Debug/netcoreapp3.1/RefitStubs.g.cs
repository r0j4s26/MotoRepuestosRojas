...
namespace MotoRepuestosRojas.RefitInternalGenerated
{
...
{
    using MotoRepuestosRojas.RefitInternalGenerated;
...
namespace Sicsoft.Checkin.Web.Servicios
{
...

    {
        ...
        /// <inheritdoc />
        Task<TEntity> ICrudApi<TEntity, TKey>.Login(string nombreUsuario, string clave)
        {
            var arguments = new object[] { nombreUsuario, clave };
            var func = requestBuilder.BuildRestResultFuncForMethod("Login", new Type[] { typeof(string), typeof(string) });
            return (Task<TEntity>)func(Client, arguments);
        }
