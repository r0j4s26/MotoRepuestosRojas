...
namespace FORECAST.Pages.Productos
{
    public class EditarModel : PageModel
    {
        ...
        public EditarModel(ICrudApi<ProductosViewModel, int> service, ICrudApi<CategoriasViewModel, int> categorias, ICrudApi<BodegasViewModel, int> serviceBodegas) //CTOR 
        {
